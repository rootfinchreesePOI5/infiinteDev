...
function Hero() {
  return <div className="flex flex-col items-center gap-10 md:gap-4 lg:gap-8 pt-[8%] md:pt-[0%]">
    ...
    <div className="bg-card border-[1px] p-8 rounded-md flex flex-col md:flex-row gap-6 items-center justify-between md:w-[80%]">
      <div className="text-center lg:w-[50%] flex flex-col gap-5">
        ...
        <button className="bg-foreground p-2 text-primary rounded-full text-xs px-8">Explore the quizzes</button>
      </div>
