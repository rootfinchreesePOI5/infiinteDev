...
function Hero() {
  return <div className="flex flex-col items-center gap-10 md:gap-4 lg:gap-8 pt-[8%] md:pt-[5%]">
    ...
    <Link href={'/courses'} className='flex items-center justify-center  firacode border-[1px] bg-foreground text-background p-2 w-full'>my courses</Link>
    </div>
